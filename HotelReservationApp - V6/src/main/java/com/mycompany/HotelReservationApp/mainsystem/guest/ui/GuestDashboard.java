...
public class GuestDashboard extends JFrame implements ActionListener {
    ...
    public GuestDashboard() {
        ...
        Logger.getInstance().info("GuestDashboard opened for user: " + SessionManager.getUsername());
    ...
    private void createComponents() {
        ...
        lblWelcome = new JLabel("Welcome, " + SessionManager.getUsername() + "!");
    ...
    private void handleLogout() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            Logger.getInstance().info("User logged out: " + SessionManager.getUsername());
